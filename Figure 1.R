...
#### load shapefile for household data 
India.HH=st_read("F:/Project_TISS/TISS_work/ClassLectures/GIS/GISFiles/Natural_Earth_quick_start/ESRI_Data/Demographics_of_India-shp/Demographics_of_India.shp")
